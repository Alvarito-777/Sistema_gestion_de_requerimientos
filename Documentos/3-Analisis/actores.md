...
|-------|-------------|
| **ID** | ACT-01 |
| **Nombre del Actor** | Desarrollador de Software |
| **Tipo** | Primario |
...
|-------|-------------|
| **ID** | ACT-02 |
| **Nombre del Actor** | Revisor de Gerencia / Jefatura |
| **Tipo** | Primario |
...
|-------|-------------|
| **ID** | ACT-03 |
| **Nombre del Actor** | Auxiliar de Talento Humano |
| **Tipo** | Secundario |
...
|-------|-------------|
| **ID** | ACT-05 |
| **Nombre del Actor** | Sistema de Notificaciones Electrónicas |
| **Tipo** | Secundario |
...
|-------|-------------|
| **ID** | ACT-06 |
| **Nombre del Actor** | Servicio de Firma Digital y Estampado de Tiempo |
| **Tipo** | Secundario |
| **Permisos / Rol** | Sistema de Persistencia e Inmutabilidad |
| **CU Relacionados** | • CU-07 (Confirmar Cierre y Calificar Servicio) <br> • CU-10 (Consultar Log de Auditoría) |
